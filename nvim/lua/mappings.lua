...
km.set({ "n" }, "<Leader>pp", function()
    require("telecope.builtin").resume()
end, opts)
km.set({ "n" }, "<Leader>rl", function()
    require("telecope.builtin").lsp_references()
end, opts)
km.set({ "n" }, "<Leader>ls", function()
    require("telecope.builtin").lsp_document_symbols()
end, opts)
km.set({ "n" }, "<Leader>ws", function()
    require("telecope.builtin").lsp_dynamic_workspace_symbols()
end, opts)
km.set({ "n" }, "<Leader>ca", function()
    require("telecope.builtin").lsp_range_code_actions()
end, opts)
km.set({ "n" }, "<Leader>ld", function()
    require("telecope.builtin").diagnostics({ bufnr = 0 })
end, opts)
